...
\begin{frame}[fragile]
    ...
    \begin{columns}
        ...
        \begin{tikzpicture}[remember picture,overlay]
            \uncover<2>{\redbox{while_3_hello-6}{2}{10}}
            \uncover<3,6,9,12>{\redbox{while_3_hello-7}{2}{15}}
            \uncover<4,7,10>{\redbox{while_3_hello-8}{4}{24}}
            \uncover<5,8,11>{\redbox{while_3_hello-9}{4}{4}}
            \uncover<13->{\redbox{while_3_hello-12}{2}{9}}
        \end{tikzpicture}
...
\begin{frame}[fragile]
    ...
    \alt<2-3>{
        ...
        \begin{tikzpicture}[remember picture,overlay]
            \uncover<3>{\redbox{while_sum_n_to_1-8}{2}{12}}
            \uncover<3>{\redbox{while_sum_n_to_1-10}{4}{9}}
        \end{tikzpicture}
    }{
        \begin{exampleblock}{编程题}
...
\begin{frame}[fragile]
    ...
    \alt<2-3>{
        ...
        \begin{tikzpicture}[remember picture,overlay]
            \uncover<3>{\redbox{while_sum_x-8}{2}{12}}
            \uncover<3>{\redbox{while_sum_x-10}{4}{9}}
            \uncover<3>{\redbox{while_sum_x-11}{4}{9}}
        \end{tikzpicture}
    }{
        \begin{exampleblock}{编程题}
...
\begin{frame}[fragile]
    ...
    \alt<2>{
        ...
        \begin{exampleblock}{编程题}
            ...
            \begin{itemize}
                \item 编写程序，第一行输入一个整数 $n$ ($1 \le n \le 1000$)，表示有 $n$ 天。接下来的 $n$ 行，每行输入两个整数 $a$, $b$ ($0 \le a, b \le 6$)，分别表示校内的学习时长和校外的学习时长。\\
...
\begin{frame}[fragile]
    ...
    \alt<2-3>{
        ...
        \begin{tikzpicture}[remember picture,overlay]
            \uncover<3>{\redbox{while_cin_sum-9}{9}{18}}
        \end{tikzpicture}
    }{
        \begin{exampleblock}{编程题}
...
\begin{frame}[fragile]
    ...
    \alt<2-6>{
        ...
        \begin{tikzpicture}[remember picture,overlay]
            \uncover<3-4>{\redbox{while_count_digit-8}{2}{12}}
            \uncover<3-4>{\redbox{while_count_digit-11}{4}{8}}
            \uncover<6->{\redbox{do_while_count_digit-9}{2}{4}}
            \uncover<6->{\redbox{do_while_count_digit-12}{2}{17}}
        \end{tikzpicture}
    }{
        \begin{exampleblock}{编程题}
...
\begin{frame}[fragile]
    ...
    \alt<2-3>{
        ...
        \begin{tikzpicture}[remember picture,overlay]
            \uncover<3>{\redbox{do_while_reverse_digit-9}{12}{6}}
        \end{tikzpicture}
    }{
        \begin{exampleblock}{编程题}
