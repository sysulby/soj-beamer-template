...
\begin{frame}[fragile]
    ...
    \alt<2-3>{
        ...
        \begin{exampleblock}{编程题}
            ...
            \begin{itemize}
                \item 第一行输入一个整数 $n$ ($1 \le n \le 100$)，表示有 $n$ 个整数，第二行输入 $n$ 个整数 $x$ ($-10^9 \le x \le 10^9$)，表示数组中的每个元素，求这 $n$ 个数组元素中的最大值及最大值出现的所有位置。\\
...
%------------------------------------------------------------
\begin{frame}[fragile]
    \frametitle{例 10.2：求前 k 个数组元素的和}
    ...
    \alt<2-3>{
        ...
        \begin{exampleblock}{编程题}
            ...
            \begin{itemize}
                \item 第一行输入一个整数 $n$ ($1 \le n \le 100$) ，表示有 $n$ 个数组元素，第二行输入 $n$ 个整数 $x$ ($-10^6 \le x \le 10^6$)，表示数组中的每个元素。再输入一个整数 $k$ ($1 \le k \le n$)，求前 $k$ 个数组元素的和。
...
\begin{frame}[fragile]
    ...
    \alt<2-3>{
        ...
        \begin{exampleblock}{编程题}
            ...
            \begin{itemize}
                \item 第一行输入一个整数 $n$ ($1 \le n \le 100$) ，表示有 $n$ 个数组元素，第二行输入 $n$ 个整数 $x$ ($-10^6 \le x \le 10^6$)，表示数组中的每个元素。再输入两个整数 $l,r$ ($1 \le l \le r \le n$)，求数组中第 $l$ 至第 $r$ 个元素之和。
            ...
            \alt<1>{
                \begin{itemize}
                    \item 6 年 A 班在选班长，有 $5$ 位候选人，编号 $1 \sim 5$，共 $n$ 名同学将进行投票。\\
                        第一行输入整数 $n$ ($1 \le n \le 100$)，如上所述，第二行输入 $n$ 个整数 $x$ ($1 \le x \le 5$)，表示每位同学的投票结果。\\
                ...
                \begin{columns}[onlytextwidth,T]
                    ...
                    \begin{itemize}
                        \item 样例输入
                            ...
                            \lstinputlisting[basicstyle=\ttfamily\small,aboveskip=.1ex,numbers=none,name=vote_1_in]{ch10/vote_1_input.txt}
        ...
        \begin{exampleblock}{编程题}
            ...
            \begin{itemize}
                \item 6 年 A 班在选班长，有 $m$ 位候选人，编号 $1 \sim m$，共 $n$ 名同学将进行投票。\\
                    第一行输入两个整数 $n$ ($1 \le n \le 100$) 和 $m$ ($1 \le m \le 10$)，如上所述，第二行输入 $n$ 个整数 $x$ ($1 \le x \le m$)，表示每位同学的投票结果。\\
        ...
        \begin{exampleblock}{编程题}
            ...
            \begin{itemize}
                \item 6 年 A 班刚刚考完期中考，编写一个程序，帮助老师统计每种分数的得分人数。\\
                    第一行输入两个整数 $n$ ($1 \le n \le 100$) 和 $m$ ($1 \le m \le 100$)，表示有 $n$ 名同学参加考试，满分为 $m$ 分。第二行依次输入 $n$ 个同学的成绩 $x$ ($0 \le x \le m$)。\\
