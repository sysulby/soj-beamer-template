...
\begin{frame}[fragile]
    ...
    \begin{columns}
        ...
        \column{.83\textwidth}
        \begin{tikzpicture}
            \matrix (A) [matrix of nodes, row 1/.style={nodes={draw=none}}, nodes={draw, minimum size=.9cm}, column sep=-\pgflinewidth, ampersand replacement=\&]{
...
\begin{frame}[fragile]
    ...
    \alt<2>{
        \lstinputlisting[language=C++,name=grade_change1]{ch09/grade_change1.cc}
    }{
        \begin{exampleblock}{编程题}
...
\begin{frame}[fragile]
    ...
    \alt<2>{
        \lstinputlisting[language=C++,name=grade_change2]{ch09/grade_change2.cc}
    }{
        \begin{exampleblock}{编程题}
...
\begin{frame}[fragile]
    ...
    \alt<2>{
        \lstinputlisting[language=C++,name=buy_book1]{ch09/buy_book1.cc}
    }{
        \begin{exampleblock}{编程题}
            \begin{itemize}
                \item 编写程序，输入两个整数 $k$ ($0 \le k < 5$) 和 $x$ ($0 \le x \le 100$)，表示购买编号为 $k$ 的图书 $x$ 本，输出消费的金额，结果保留两位小数。图书的单价如图所示。
                    ...
                    \begin{tikzpicture}
                        \matrix (A) [matrix of nodes, row 1/.style={nodes={draw=none}}, nodes={draw, minimum size=.9cm}, column sep=-\pgflinewidth, ampersand replacement=\&]{
                            \small{b[0]} \& \small{b[1]} \& \small{b[2]} \& \small{b[3]} \& \small{b[4]} \\
...
\begin{frame}[fragile]
    ...
    \alt<2>{
        \lstinputlisting[language=C++,name=buy_book2]{ch09/buy_book2.cc}
    }{
        \begin{exampleblock}{编程题}
...
\begin{frame}[fragile]
    ...
    \alt<2>{
        \lstinputlisting[language=C++,name=array_alt_output]{ch09/array_alt_output.cc}
    }{
        \begin{exampleblock}{编程题}
...
\begin{frame}[fragile]
    ...
    \alt<5>{
        \lstinputlisting[language=C++,name=array_copy_ac]{ch09/array_copy_ac.cc}
    }{
        \alt<3-4>{
            \begin{itemize}
                ...
                \item<4-> 只能将元素依次进行赋值
                    ...
                    \begin{itemize}
                        \item \lstinline|for (int i = 1; i <= n; i++) b[i] = a[i];|
                    \end{itemize}

            \end{itemize}
        }{
            \lstinputlisting[language=C++,name=array_copy_wa]{ch09/array_copy_wa.cc}
            ...
            \begin{tikzpicture}[remember picture, overlay]
                \uncover<2>{\redbox{array_copy_wa-13}{2}{6}}
            \end{tikzpicture}
        }
    }
\end{frame}
...
\begin{frame}[fragile]
    ...
    \alt<2>{
        \lstinputlisting[language=C++,name=array_sum]{ch09/array_sum.cc}
    }{
        \begin{exampleblock}{编程题}
...
\begin{frame}[fragile]
    ...
    \alt<2>{
        \lstinputlisting[language=C++,name=array_max]{ch09/array_max.cc}
    }{
        \begin{exampleblock}{编程题}
...
\begin{frame}[fragile]
    ...
    \alt<2-3>{
        \lstinputlisting[language=C++,name=array_max_with_pos]{ch09/array_max_with_pos.cc}

        \begin{tikzpicture}[remember picture, overlay]
            \uncover<3>{\redbox{array_max_with_pos-15}{8}{25}}
        \end{tikzpicture}
    }{
        \begin{exampleblock}{编程题}
...
\begin{frame}[fragile]
    ...
    \alt<2-3>{
        \lstinputlisting[language=C++,name=array_max_all_pos]{ch09/array_max_all_pos.cc}

        \begin{tikzpicture}[remember picture, overlay]
            \uncover<3>{\redbox{array_max_all_pos-17}{4}{37}}
        \end{tikzpicture}
    }{
        \begin{exampleblock}{编程题}
