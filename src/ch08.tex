...
\begin{frame}[fragile]
    ...
    \alt<2>{
        \lstinputlisting[language=C++]{ch08/cal_seq1.cc}
    }{
...
\begin{frame}[fragile]
    ...
    \alt<2>{
        \lstinputlisting[language=C++]{ch08/star_m.cc}
    }{
        \begin{exampleblock}{编程题}
...
\begin{frame}[fragile]
    ...
    % \alt<2>{
        % \lstinputlisting[language=C++]{ch08/star_n_m.cc}
    % }
    {
        \begin{exampleblock}{编程题}
...
\begin{frame}[fragile]
    ...
    \begin{columns}
        ...
        \begin{tikzpicture}[overlay]
            ...
            % width = (0,6.4)
            % int i = 1;
            \uncover<2>{\draw[red, very thick] (1.665,3.28) rectangle (3.6,3.71);}
            % i <= n
            \uncover<3,17,31>{\draw[red, very thick] (3.7,3.28) rectangle (5.1,3.71);}
            % i++
            \uncover<16,30>{\draw[red, very thick] (5.2,3.28) rectangle (5.9,3.71);}
            % int j = 1;
            \uncover<4,18>{\draw[red, very thick] (2.45,2.90) rectangle (4.4,3.33);}
            % j <= m;
            \uncover<5,8,11,14,19,22,25,28>{\draw[red, very thick] (4.5,2.90) rectangle (5.9,3.33);}
            % j++
            \uncover<7,10,13,21,24,27>{\draw[red, very thick] (6.0,2.90) rectangle (6.7,3.33);}
            % cout << "*";
            \uncover<6,9,12,20,23,26>{\draw[red, very thick] (0,2.47) rectangle (6.4,2.95);}
            % cout << endl;
            \uncover<15,29>{\draw[red, very thick] (0,1.72) rectangle (6.4,2.15);}
            % return 0;
            \uncover<32>{\draw[red, very thick] (0,0.97) rectangle (6.4,1.40);}
        \end{tikzpicture}
...
\begin{frame}[fragile]
    ...
    \alt<2>{
        \lstinputlisting[language=C++]{ch08/num_n_m.cc}
    }{
        \begin{exampleblock}{编程题}
...
\begin{frame}[fragile]
    ...
    \alt<2>{
        \lstinputlisting[language=C++]{ch08/num_ij.cc}
    }{
        \begin{exampleblock}{编程题}
...
\begin{frame}[fragile]
    ...
    \alt<2>{
        \lstinputlisting[language=C++]{ch08/num_triangle.cc}
    }{
        \begin{exampleblock}{编程题}
...
\begin{frame}[fragile]
    ...
    \alt<2-3>{
        \lstinputlisting[language=C++]{ch08/cal_seq2.cc}
        \begin{tikzpicture}[overlay]
            \only<3>{\draw[red, very thick] (1.3,3.30) rectangle (3,3.73);}
        \end{tikzpicture}
    }{
        \begin{exampleblock}{编程题}
...
\begin{frame}[fragile]
    ...
    \lstinputlisting[language=C++]{ch08/cal_seq3.cc}
\end{frame}
%------------------------------------------------------------
...
\begin{frame}[fragile]
    ...
    \alt<2-3>{
        \lstinputlisting[language=C++]{ch08/rectangle_hollow.cc}
        \begin{tikzpicture}[overlay]
            \only<3>{\draw[red, very thick] (3,4) rectangle (9.9,4.43);}
        \end{tikzpicture}
    }{
        \begin{exampleblock}{编程题}
...
\begin{frame}[fragile]
    ...
    \alt<2>{
        \lstinputlisting[language=C++]{ch08/triangle_isosceles.cc}
    }{
        \begin{exampleblock}{编程题}
    ...
    \alt<2-6>{
        \alt<2-4> {
            \begin{columns}
                ...
                \column{.65\textwidth}
                \lstinputlisting[language=C++]{ch08/cnt_1_1.cc}
            ...
            \begin{columns}
                ...
                \column{.65\textwidth}
                \lstinputlisting[language=C++]{ch08/cnt_1_2.cc}

                \begin{tikzpicture}[overlay]
                    \only<6->{\draw[red, very thick] (0.5,3.67) rectangle (3.2,4.10);}
                \end{tikzpicture}
    ...
    \alt<2-6>{
        \alt<2-4> {
            \begin{columns}
                ...
                \column{.65\textwidth}
                \lstinputlisting[language=C++]{ch08/count_1_1.cc}
            ...
            \begin{columns}
                ...
                \column{.65\textwidth}
                \lstinputlisting[language=C++]{ch08/count_1_2.cc}
                
                \begin{tikzpicture}[overlay]
                    \only<6->{\draw[red, very thick] (1.3,4.07) rectangle (4,4.50);}
                \end{tikzpicture}
...
\begin{frame}[fragile]
    ...
    \uncover<1->{\lstinputlisting[language=C++]{ch08/for_break_1.cc}}
    \uncover<3->{\lstinputlisting[language=C++]{ch08/for_break_2.cc}}

    \begin{tikzpicture}[overlay]
        \uncover<2->{\draw[red, very thick] (0,6) rectangle (3.6,6.44);}
        \uncover<2->{\draw[red, very thick, ->] (3.6,6.215) -- (6.5,6.215) -- (6.5,4.7) -- (0.3,4.7);}
        \uncover<4>{\draw[red, very thick] (0,2.9) rectangle (2.8,3.33);}
        \uncover<4->{\draw[red, very thick, ->] (2.8,3.12) -- (6.5,3.12) -- (6.5,0.8) -- (0.3,0.8);}
    \end{tikzpicture}
...
\begin{frame}[fragile]
    ...
    \uncover<1->{\lstinputlisting[language=C++]{ch08/for_continue_1.cc}}
    \uncover<3->{\lstinputlisting[language=C++]{ch08/for_continue_2.cc}}

    \begin{tikzpicture}[overlay]
        \uncover<2->{\draw[red, very thick] (0,6) rectangle (4,6.44);}
        \uncover<2->{\draw[red, very thick, ->] (4,6.215) -- (5.6,6.215) -- (5.6,6.8);}
        \uncover<4>{\draw[red, very thick] (0,2.9) rectangle (3.3,3.33);}
        \uncover<4->{\draw[red, very thick, ->] (3.3,3.12) -- (4.9,3.12) -- (4.9,3.7);}
    \end{tikzpicture}
