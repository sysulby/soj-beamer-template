        ...
        \alt<2>{
            ...
            \begin{itemize}
                \item 当输入 n 为 3，m 为 4 时，输出如图所示
                    ...
                    \lstinputlisting[numbers=none,name=num_ij_output]{ch08/num_ij_output.txt}

                    \begin{tikzpicture}[remember picture, overlay]
                        \uncover<4>{\redbox{num_ij_output}{2}{1}{2}{23} node[right,yshift=.2cm]{\lstinline|i = 1|};}
                        \uncover<5>{\redbox{num_ij_output}{3}{1}{3}{23} node[right,yshift=.2cm]{\lstinline|i = 2|};}
                        \uncover<6>{\redbox{num_ij_output}{4}{1}{4}{23} node[right,yshift=.2cm]{\lstinline|i = 3|};}
                        \uncover<7>{\redbox{num_ij_output}{2}{1}{4}{5} node[below,xshift=-.5cm]{\lstinline|j = 1|};}
                        \uncover<8>{\redbox{num_ij_output}{2}{7}{4}{11} node[below,xshift=-.5cm]{\lstinline|j = 2|};}
                        \uncover<9>{\redbox{num_ij_output}{2}{13}{4}{17} node[below,xshift=-.5cm]{\lstinline|j = 3|};}
                        \uncover<10>{\redbox{num_ij_output}{2}{19}{4}{23} node[below,xshift=-.5cm]{\lstinline|j = 4|};}
                    \end{tikzpicture}
...
\begin{frame}[fragile]
    ...
    \alt<2-3>{
        ...
        \begin{tikzpicture}[remember picture, overlay]
            \only<3>{\redbox{cal_seq2}{11}{5}{11}{11};}
        \end{tikzpicture}
    }{
        \begin{exampleblock}{编程题}
...
\begin{frame}[fragile]
    ...
    \alt<2-6>{
        ...
        \begin{exampleblock}{编程题}
            ...
            \begin{itemize}
                \item 编写程序，输入一个整数 $n$ ($1 \leq n \leq 10^9$)，输出 $n$ 及其数位中 $1$ 的个数，用空格间隔。
...
\begin{frame}[fragile]
    ...
    \begin{tikzpicture}[remember picture, overlay]
        ...
        \uncover<2->{\draw[red, very thick, ->] ([shift={(2pt, .27em)}] pic cs:line-for_break_1-4-end) -- ++(4em, 0) |- ([shift={(2pt, .27em)}] pic cs:line-for_break_1-6-end);}
        \uncover<4>{\redbox{for_break_2}{3}{5}{3}{10};}
        \uncover<4>{\draw[red, very thick, ->] ([shift={(2pt, .27em)}] pic cs:line-for_break_2-3-end) -- ++(10em, 0) |- ([shift={(2pt, .27em)}] pic cs:line-for_break_2-9-end);}
    \end{tikzpicture}
...
\begin{frame}[fragile]
    ...
    \begin{tikzpicture}[remember picture, overlay]
        ...
        \uncover<2->{\draw[red, very thick, ->] ([shift={(2pt, .27em)}] pic cs:line-for_continue_1-4-end) -| ([shift={(-.8cm, -.2em)}] pic cs:line-for_continue_1-2-end);}
        \uncover<4>{\redbox{for_continue_2}{3}{5}{3}{13};}
        \uncover<4>{\draw[red, very thick, ->] ([shift={(2pt, .27em)}] pic cs:line-for_continue_2-3-end) -| ([shift={(-.8cm, -.2em)}] pic cs:line-for_continue_2-1-end);}
    \end{tikzpicture}
