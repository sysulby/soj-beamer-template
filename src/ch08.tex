        ...
        \alt<2>{
            ...
            \begin{itemize}
                \item 当输入 n 为 3，m 为 4 时，输出如图所示
                    ...
                    \lstinputlisting[basicstyle=\ttfamily\small,numbers=none,name=num_ij_output]{ch08/num_ij_output.txt}

                    \begin{tikzpicture}[remember picture, overlay, scale=1.25]
                        \uncover<4>{\redbox{num_ij_output}{2}{1}{2}{23} node[right,yshift=.22cm]{\lstinline|i = 1|};}
                        \uncover<5>{\redbox{num_ij_output}{3}{1}{3}{23} node[right,yshift=.22cm]{\lstinline|i = 2|};}
                        \uncover<6>{\redbox{num_ij_output}{4}{1}{4}{23} node[right,yshift=.22cm]{\lstinline|i = 3|};}
                        \uncover<7>{\redbox{num_ij_output}{2}{1}{4}{5} node[below,xshift=-.55cm]{\lstinline|j = 1|};}
                        \uncover<8>{\redbox{num_ij_output}{2}{7}{4}{11} node[below,xshift=-.55cm]{\lstinline|j = 2|};}
                        \uncover<9>{\redbox{num_ij_output}{2}{13}{4}{17} node[below,xshift=-.55cm]{\lstinline|j = 3|};}
                        \uncover<10>{\redbox{num_ij_output}{2}{19}{4}{23} node[below,xshift=-.55cm]{\lstinline|j = 4|};}
                    \end{tikzpicture}
...
\begin{frame}[fragile]
    ...
    \lstinputlisting[basicstyle=\ttfamily\scriptsize,language=C++,name=cal_seq3]{ch08/cal_seq3.cc}
\end{frame}
%------------------------------------------------------------
