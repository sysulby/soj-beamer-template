            ...
            \begin{exampleblock}{编程题}
                ...
                \begin{columns}[onlytextwidth,T]
                    ...
                    \begin{itemize}
                        ...
                        \lstinputlisting[basicstyle=\ttfamily\small,numbers=none,name=cnt_1_i]{ch12/cnt_1_i.txt}
    
                        \begin{tikzpicture}[remember picture, overlay,scale=1.25]
                            
                            \uncover<3>{\redbox{cnt_1_i}{3}{1}{3}{2};}
    
                            
                            \uncover<4>{\redbox{cnt_1_i}{3}{4}{3}{5};}
                            \uncover<4>{\redbox{cnt_1_i}{3}{1}{3}{2};}
    
                            
                            \uncover<5>{\redbox{cnt_1_i}{3}{7}{3}{8};}
                            \uncover<5>{\redbox{cnt_1_i}{3}{1}{3}{5};}
    
                            
                            \uncover<6>{\redbox{cnt_1_i}{3}{10}{3}{12};}
                            \uncover<6>{\redbox{cnt_1_i}{3}{1}{3}{8};}
    
                            
                            \uncover<7>{\redbox{cnt_1_i}{3}{14}{3}{15};}
                            \uncover<7>{\redbox{cnt_1_i}{3}{1}{3}{12};}
                        \end{tikzpicture}
                    ...
                    \begin{itemize}
                        ...
                        \lstinputlisting[basicstyle=\ttfamily\small,numbers=none,name=cnt_1_o]{ch12/cnt_1_o.txt}
            ...
            \begin{exampleblock}{编程题}
                ...
                \begin{columns}[onlytextwidth,T]
                    ...
                    \begin{itemize}
                        ...
                        \lstinputlisting[basicstyle=\ttfamily\small,numbers=none,name=cnt_2_i]{ch12/cnt_2_i.txt}
                    ...
                    \begin{itemize}
                        ...
                        \lstinputlisting[basicstyle=\ttfamily\small,numbers=none,name=cnt_2_o]{ch12/cnt_2_o.txt}
            ...
            \begin{columns}[onlytextwidth,T]
                ...
                \begin{itemize}
                    \item 样例输入
                        ...
                        \begin{tikzpicture}[remember picture,overlay,scale=1.25]
                            \uncover<4->{\redbox{small_matrix_i}{2}{5}{2}{5} node[right,xshift=.7cm,yshift=.2cm]{\lstinline|第\ x 行，第 y 列|};}
                            \uncover<4->{\redbox{small_matrix_i}{6}{1}{6}{3} node[below,xshift=.1cm]{\lstinline|起点：(x,y)|};}
                            \uncover<5->{\redbox{small_matrix_i}{4}{7}{4}{7};}
                ...
                \begin{columns}[onlytextwidth,T]
                    ...
                    \begin{itemize}
                        \item 样例输入
                            ...
                            \begin{tikzpicture}[remember picture,overlay,scale=1.25]
                                \uncover<2>{\redbox{small_matrix_i}{2}{5}{2}{5} node[right,xshift=.7cm,yshift=.2cm]{\lstinline|第\ 1 行，第 3 列|};}
                                \uncover<2>{\redbox{small_matrix_i}{6}{1}{6}{3} node[below,xshift=.1cm]{\lstinline|起点：(1,3)|};}
                                \uncover<3>{\redbox{small_matrix_i}{4}{7}{4}{7};}
                                \uncover<3>{\redbox{small_matrix_i}{2}{5}{4}{7} node[right,xshift=.3cm,yshift=.2cm]{\lstinline|第\ 3 行，第 5 列|};}
