...
\begin{frame}[fragile]
    ...
    \lstinputlisting[language=C++,name=structure]{ch02/structure.cc}
\end{frame}
%------------------------------------------------------------
...
\begin{frame}[fragile]
    ...
    \alt<2>{
        \lstinputlisting[language=C++,name=output2]{ch02/output2.cc}
    }{
        \lstinputlisting[language=C++,name=output1]{ch02/output1.cc}
    }
\end{frame}
%------------------------------------------------------------
...
\begin{frame}[fragile]
    ...
    \lstinputlisting[language=C++,name=output3]{ch02/output3.cc}
...
\begin{frame}[fragile]
    ...
    \alt<2>{
        \lstinputlisting[language=C++,name=example1]{ch02/example1.cc}
    }{
...
\begin{frame}[fragile]
    ...
    \alt<2>{
        \lstinputlisting[language=C++,name=example2]{ch02/example2.cc}
    }{
        \begin{exampleblock}{编程题}
            ...
            \begin{itemize}
                ...
                \item 输出分两行，第一行输出长，第二行输出宽。结果保留 $2$ 位小数。
...
\begin{frame}[fragile]
    ...
    \lstinputlisting[language=C++,name=cast]{ch02/cast.cc}
