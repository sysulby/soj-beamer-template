...
\begin{frame}[fragile]
    ...
    \alt<2-3>{
        ...
        \begin{tikzpicture}[remember picture,overlay]
            \uncover<3>{\redbox{factors_sum-11}{6}{9}}
        \end{tikzpicture}
    }{
        \begin{exampleblock}{编程题}
...
\begin{frame}[fragile]
    ...
    \alt<2-8>{
        \alt<7-8> {
            \begin{itemize}
                    \lstinputlisting[language=C++,name=for_max_x]{ch07/for_max_x.cc}

                \item 把擂主的初始值设置为最小值，确保第一个挑战者攻擂成功
            \end{itemize}

            \begin{tikzpicture}[remember picture,overlay]
                \uncover<8>{\redbox{for_max_x-8}{2}{23}}
                \uncover<8>{\redbox{for_max_x-11}{8}{8}}
            \end{tikzpicture}
        }{
            \begin{itemize}
                \item 打擂台找最大值
...
\begin{frame}[fragile]
    ...
    \alt<2-3>{
        \lstinputlisting[language=C++,name=for_max_x_with_pos]{ch07/for_max_x_with_pos.cc}

        \begin{tikzpicture}[remember picture,overlay]
            \uncover<3>{\redbox{for_max_x_with_pos-9}{2}{12}}
            \uncover<3>{\redbox{for_max_x_with_pos-14}{6}{8}}
        \end{tikzpicture}
    }{
        \begin{exampleblock}{编程题}
...
\begin{frame}[fragile]
    ...
    \alt<2-3>{
        ...
        \begin{tikzpicture}[remember picture,overlay]
            \uncover<3>{\redbox{num_of_digit_3-10}{4}{15}}
            \uncover<3>{\redbox{num_of_digit_3-12}{8}{6}}
        \end{tikzpicture}
    }{
        \begin{exampleblock}{编程题}
...
\begin{frame}[fragile]
    ...
    \begin{tikzpicture}[remember picture,overlay]
        \uncover<2->{\redbox{while_break-4}{4}{6}}
        \uncover<2->{\draw[red, very thick, ->] (pic cs:line-while_break-4-end) ++(2pt, .3em) -- ++(2em, 0) -- ++(0, -2.7em) -- ++(-6em, 0);}
        \uncover<4>{\redbox{for_break-4}{4}{6}}
        \uncover<4>{\draw[red, very thick, ->] (pic cs:line-for_break-4-end) ++(2pt, .3em) -- ++(2em, 0) -- ++(0, -2.7em) -- ++(-6em, 0);}
    \end{tikzpicture}
\end{frame}
%------------------------------------------------------------
...
\begin{frame}[fragile]
    ...
    \begin{tikzpicture}[remember picture,overlay]
        \uncover<2->{\redbox{while_continue-4}{4}{9}}
        \uncover<2->{\draw[red, very thick, ->] (pic cs:line-while_continue-4-end) ++(2pt, .3em) -- ++(2em, 0) -- ++(0, 2.5em) -- ++(-2em, 0);}
        \uncover<4>{\redbox{for_continue-4}{4}{9}}
        \uncover<4>{\draw[red, very thick, ->] (pic cs:line-for_continue-4-end) ++(2pt, .3em) -- ++(5.5em, 0) -- ++(0, 2.1em);}
    \end{tikzpicture}
...
\begin{frame}[fragile]
    ...
    \begin{tikzpicture}[remember picture,overlay]
        \uncover<3->{\redbox{while_1_n_break-5}{4}{6}}
        \uncover<3->{\draw[red, very thick, ->] (pic cs:line-while_1_n_break-5-end) ++(2pt, .3em) -- ++(5em, 0) -- ++(0, -3.6em) -- ++(-9em, 0);}
        \uncover<5>{\redbox{for_1_n_break-5}{4}{6}}
        \uncover<5>{\draw[red, very thick, ->] (pic cs:line-for_1_n_break-5-end) ++(2pt, .3em) -- ++(5em, 0) -- ++(0, -2.7em) -- ++(-9em, 0);}
    \end{tikzpicture}
\end{frame}
%------------------------------------------------------------
...
\begin{frame}[fragile]
    ...
    \begin{columns}[T]
        ...
        \column{.43\textwidth}
        \uncover<2-5>{\lstinputlisting[language=C++,name=while_1_n_continue]{ch07/while_1_n_continue.cc}}

        \column{.53\textwidth}
        \uncover<4-5>{\lstinputlisting[language=C++,name=for_1_n_continue]{ch07/for_1_n_continue.cc}}
    \end{columns}

    \begin{tikzpicture}[remember picture,overlay]
        \uncover<3->{\redbox{while_1_n_continue-5}{4}{9}}
        \uncover<3->{\draw[red, very thick, ->] (pic cs:line-while_1_n_continue-5-end) ++(2pt, .3em) -- ++(3em, 0) -- ++(0, 1.7em) -- ++(-1.8em, 0);}
        \uncover<5>{\redbox{for_1_n_continue-5}{4}{9}}
        \uncover<5>{\draw[red, very thick, ->] (pic cs:line-for_1_n_continue-5-end) ++(2pt, .3em) -- ++(5.5em, 0) -- ++(0, 1.3em);}
    \end{tikzpicture}
