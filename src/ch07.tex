...
\begin{frame}[fragile]
    ...
    \begin{tikzpicture}[remember picture,overlay]
        ...
        \uncover<2->{\draw[red, very thick, ->] (pic cs:line-while_break-3-end) ++(2pt, .3em) -- ++(2em, 0) -- ++(0, -1.8em) -- ++(-9em, 0);}
        \uncover<4>{\redbox{for_break-3}{11}{6}}
        \uncover<4>{\draw[red, very thick, ->] (pic cs:line-for_break-3-end) ++(2pt, .3em) -- ++(2em, 0) -- ++(0, -1.8em) -- ++(-9em, 0);}
    \end{tikzpicture}
\end{frame}
%------------------------------------------------------------
...
\begin{frame}[fragile]
    ...
    \begin{tikzpicture}[remember picture,overlay]
        ...
        \uncover<2->{\draw[red, very thick, ->] (pic cs:line-while_continue-3-end) ++(2pt, .3em) -- ++(2em, 0) -- ++(0, 1.6em) -- ++(-5em, 0);}
        \uncover<4>{\redbox{for_continue-3}{11}{9}}
        \uncover<4>{\draw[red, very thick, ->] (pic cs:line-for_continue-3-end) ++(2pt, .3em) -- ++(2em, 0) -- ++(0, 1.2em);}
    \end{tikzpicture}
...
\begin{frame}[fragile]
    ...
    \begin{tikzpicture}[remember picture,overlay]
        ...
        \uncover<3->{\draw[red, very thick, ->] (pic cs:line-while_1_n_break-4-end) ++(2pt, .3em) -- ++(2em, 0) -- ++(0, -2.7em) -- ++(-10em, 0);}
        \uncover<5>{\redbox{for_1_n_break-4}{14}{6}}
        \uncover<5>{\draw[red, very thick, ->] (pic cs:line-for_1_n_break-4-end) ++(2pt, .3em) -- ++(2em, 0) -- ++(0, -1.8em) -- ++(-10em, 0);}
    \end{tikzpicture}
\end{frame}
%------------------------------------------------------------
...
\begin{frame}[fragile]
    ...
    \begin{tikzpicture}[remember picture,overlay]
        ...
        \uncover<3->{\draw[red, very thick, ->] (pic cs:line-while_1_n_continue-4-end) ++(2pt, .3em) -- ++(1em, 0) -- ++(0, 0.85em) -- ++(-4em, 0);}
        \uncover<5>{\redbox{for_1_n_continue-4}{14}{9}}
        \uncover<5>{\draw[red, very thick, ->] (pic cs:line-for_1_n_continue-4-end) ++(2pt, .3em) -- ++(1em, 0) -- ++(0, 0.55em);}
    \end{tikzpicture}
