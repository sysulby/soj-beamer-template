...
\begin{frame}[fragile]
    ...
    \begin{tikzpicture}[remember picture,overlay]
        ...
        \uncover<2->{\draw[red, very thick, ->] ([shift={(2pt, .27em)}] pic cs:line-while_break-4-end) -- ++(2em, 0) |- ([shift={(2pt, .27em)}] pic cs:line-while_break-7-end);}
        \uncover<4>{\redbox{for_break}{4}{5}{4}{10};}
        \uncover<4>{\draw[red, very thick, ->] ([shift={(2pt, .27em)}] pic cs:line-for_break-4-end) -- ++(2em, 0) |- ([shift={(2pt, .27em)}] pic cs:line-for_break-7-end);}
    \end{tikzpicture}
\end{frame}
%------------------------------------------------------------
...
\begin{frame}[fragile]
    ...
    \begin{tikzpicture}[remember picture,overlay]
        ...
        \uncover<2->{\draw[red, very thick, ->] ([shift={(2pt, .27em)}] pic cs:line-while_continue-4-end) -- ++(2em, 0) |- ([shift={(2pt, .27em)}] pic cs:line-while_continue-1-end);}
        \uncover<4>{\redbox{for_continue}{4}{5}{4}{13};}
        \uncover<4>{\draw[red, very thick, ->] ([shift={(2pt, .27em)}] pic cs:line-for_continue-4-end) -| ([shift={(-.8cm, -.2em)}] pic cs:line-for_continue-1-end);}
    \end{tikzpicture}
...
\begin{frame}[fragile]
    ...
    \begin{tikzpicture}[remember picture,overlay]
        ...
        \uncover<3->{\draw[red, very thick, ->] ([shift={(2pt, .27em)}] pic cs:line-while_1_n_break-5-end) -- ++(5em, 0) |- ([shift={(2pt, .27em)}] pic cs:line-while_1_n_break-9-end);}
        \uncover<5>{\redbox{for_1_n_break}{5}{5}{5}{10};}
        \uncover<5>{\draw[red, very thick, ->] ([shift={(2pt, .27em)}] pic cs:line-for_1_n_break-5-end) -- ++(5em, 0) |- ([shift={(2pt, .27em)}] pic cs:line-for_1_n_break-8-end);}
    \end{tikzpicture}
\end{frame}
%------------------------------------------------------------
...
\begin{frame}[fragile]
    ...
    \begin{tikzpicture}[remember picture,overlay]
        ...
        \uncover<3->{\draw[red, very thick, ->] ([shift={(2pt, .27em)}] pic cs:line-while_1_n_continue-5-end) -- ++(3em, 0) |- ([shift={(2pt, .27em)}] pic cs:line-while_1_n_continue-3-end);}
        \uncover<5>{\redbox{for_1_n_continue}{5}{5}{5}{13};}
        \uncover<5>{\draw[red, very thick, ->] ([shift={(2pt, .27em)}] pic cs:line-for_1_n_continue-5-end) -| ([shift={(-.8cm, -.2em)}] pic cs:line-for_1_n_continue-3-end);}
    \end{tikzpicture}
