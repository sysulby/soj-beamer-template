...
\begin{frame}[fragile]
    ...
    \begin{itemize}
            ...
            \lstinputlisting[language=C++,name=while]{ch06/while.cc}

        \item 不断依照条件语句判定是否继续执行循环
...
\begin{frame}[fragile]
    ...
    \begin{itemize}[<+->]
            ...
            \lstinputlisting[language=C++,name=while]{ch06/do_while.cc}

        \item 先执行一次循环体，再依照条件语句判定是否继续执行循环
...
\begin{frame}[fragile]
    ...
    \alt<2>{
        \lstinputlisting[language=C++,name=while_n_to_1]{ch06/while_n_to_1.cc}
    }{
...
\begin{frame}[fragile]
    ...
    \begin{itemize}
        ...
        \item<2-> \lstinline|do...while| 循环：先执行再判断，至少执行一次
            ...
            \only<2> {
                \lstinputlisting[language=C++,name=do_while]{ch06/do_while.cc}
            }
