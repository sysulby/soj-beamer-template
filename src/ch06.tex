...
\begin{frame}[fragile]
    ...
    \alt<2-3>{
        ...
        \begin{exampleblock}{编程题}
            ...
            \begin{itemize}
                \item 输入一个整数 $n$ ($1 \le n \le 1000$)，输出从 $1$ 到 $n$ 之间的整数，每个数字单独占一行。
...
\begin{frame}[fragile]
    ...
    \alt<2-5>{
        ...
        \begin{exampleblock}{编程题}
            ...
            \begin{itemize}
                \item 输入一个整数 $n$ ($1 \le n \le 1000$)，输出从 $0$ 到 $n-1$ 之间的整数，每个数字单独占一行。
...
\begin{frame}[fragile]
    ...
    \alt<2-3>{
        ...
        \begin{exampleblock}{编程题}
            ...
            \begin{itemize}
                \item 输入两个整数 $L$ 和 $R$ ($1 \le L < R \le 1000$)，输出从 $L$ 到 $R$ 之间的整数，每个数字之间用空格间隔。
...
\begin{frame}[fragile]
    ...
    \alt<2-3>{
        ...
        \begin{exampleblock}{编程题}
            ...
            \begin{itemize}
                \item 输入一个整数 $n$ ($1 \le n \le 1000$)，保证 $n$ 为奇数，输出从 $1$ 到 $n$ 之间的奇数，每个数字之间用空格间隔。
